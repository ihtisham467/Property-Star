    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.clients.update", [$client->id]) }}" enctype="multipart/form-data">
            ...
            {{-- <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('clientid') ? 'is-invalid' : '' }}" type="text" name="clientid" id="clientid" value="{{ old('clientid', $client->clientid) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('membership_no') ? 'is-invalid' : '' }}" type="text" name="membership_no" id="membership_no" value="{{ old('membership_no', $client->membership_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_membership') ? 'is-invalid' : '' }}" type="text" name="date_of_membership" id="date_of_membership" value="{{ old('date_of_membership', $client->date_of_membership) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cnic_nicop_no') ? 'is-invalid' : '' }}" type="text" name="cnic_nicop_no" id="cnic_nicop_no" value="{{ old('cnic_nicop_no', $client->cnic_nicop_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('passport_no') ? 'is-invalid' : '' }}" type="text" name="passport_no" id="passport_no" value="{{ old('passport_no', $client->passport_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('father_name') ? 'is-invalid' : '' }}" type="text" name="father_name" id="father_name" value="{{ old('father_name', $client->father_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('profession') ? 'is-invalid' : '' }}" type="text" name="profession" id="profession" value="{{ old('profession', $client->profession) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_name') ? 'is-invalid' : '' }}" type="text" name="spouse_name" id="spouse_name" value="{{ old('spouse_name', $client->spouse_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_profession') ? 'is-invalid' : '' }}" type="text" name="spouse_profession" id="spouse_profession" value="{{ old('spouse_profession', $client->spouse_profession) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('education') ? 'is-invalid' : '' }}" type="text" name="education" id="education" value="{{ old('education', $client->education) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nationality') ? 'is-invalid' : '' }}" type="text" name="nationality" id="nationality" value="{{ old('nationality', $client->nationality) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('religion') ? 'is-invalid' : '' }}" type="text" name="religion" id="religion" value="{{ old('religion', $client->religion) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('resident_villa_no') ? 'is-invalid' : '' }}" type="text" name="resident_villa_no" id="resident_villa_no" value="{{ old('resident_villa_no', $client->resident_villa_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('street_no') ? 'is-invalid' : '' }}" type="text" name="street_no" id="street_no" value="{{ old('street_no', $client->street_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sector') ? 'is-invalid' : '' }}" type="text" name="sector" id="sector" value="{{ old('sector', $client->sector) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city_id" id="city_id" required>
                    @foreach($cities as $id => $entry)
                        <option value="{{ $id }}" {{ (old('city_id') ? old('city_id') : $client->city->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('city'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('date_of_birth') ? 'is-invalid' : '' }}" type="date" name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', $client->date_of_birth) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('present_address') ? 'is-invalid' : '' }}" type="text" name="present_address" id="present_address" value="{{ old('present_address', $client->present_address) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('office_contact') ? 'is-invalid' : '' }}" type="text" name="office_contact" id="office_contact" value="{{ old('office_contact', $client->office_contact) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('home_contact') ? 'is-invalid' : '' }}" type="text" name="home_contact" id="home_contact" value="{{ old('home_contact', $client->home_contact) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('permanent_address') ? 'is-invalid' : '' }}" type="text" name="permanent_address" id="permanent_address" value="{{ old('permanent_address', $client->permanent_address) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('domicile') ? 'is-invalid' : '' }}" type="text" name="domicile" id="domicile" value="{{ old('domicile', $client->domicile) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('next_of_kin') ? 'is-invalid' : '' }}" type="text" name="next_of_kin" id="next_of_kin" value="{{ old('next_of_kin', $client->next_of_kin) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('relation_kin') ? 'is-invalid' : '' }}" type="text" name="relation_kin" id="relation_kin" value="{{ old('relation_kin', $client->relation_kin) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cnic_ni_cop_kin_no') ? 'is-invalid' : '' }}" type="text" name="cnic_ni_cop_kin_no" id="cnic_ni_cop_kin_no" value="{{ old('cnic_ni_cop_kin_no', $client->cnic_ni_cop_kin_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('passport_no_kin') ? 'is-invalid' : '' }}" type="text" name="passport_no_kin" id="passport_no_kin" value="{{ old('passport_no_kin', $client->passport_no_kin) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('referred_by') ? 'is-invalid' : '' }}" type="text" name="referred_by" id="referred_by" value="{{ old('referred_by', $client->referred_by) }}">
