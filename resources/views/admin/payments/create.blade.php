    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.payments.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('challan_no') ? 'is-invalid' : '' }}" type="text" name="challan_no" id="challan_no" value="{{ old('challan_no', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('payment_medium') ? 'is-invalid' : '' }}" name="payment_medium" id="payment_medium" required>
                    ...
                    @foreach(App\Models\Payment::PAYMENT_MEDIUM_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('payment_medium', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank_slip_no') ? 'is-invalid' : '' }}" type="text" name="bank_slip_no" id="bank_slip_no" value="{{ old('bank_slip_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('bank_payment_date') ? 'is-invalid' : '' }}" type="text" name="bank_payment_date" id="bank_payment_date" value="{{ old('bank_payment_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_no_from') ? 'is-invalid' : '' }}" type="text" name="account_no_from" id="account_no_from" value="{{ old('account_no_from', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank_name_to') ? 'is-invalid' : '' }}" type="text" name="bank_name_to" id="bank_name_to" value="{{ old('bank_name_to', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_no_to') ? 'is-invalid' : '' }}" type="text" name="account_no_to" id="account_no_to" value="{{ old('account_no_to', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('depositor_name') ? 'is-invalid' : '' }}" type="text" name="depositor_name" id="depositor_name" value="{{ old('depositor_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('depositor_cnic') ? 'is-invalid' : '' }}" type="text" name="depositor_cnic" id="depositor_cnic" value="{{ old('depositor_cnic', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('depositor_contact') ? 'is-invalid' : '' }}" type="text" name="depositor_contact" id="depositor_contact" value="{{ old('depositor_contact', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cachier_name') ? 'is-invalid' : '' }}" type="text" name="cachier_name" id="cachier_name" value="{{ old('cachier_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cashier_cnic') ? 'is-invalid' : '' }}" type="text" name="cashier_cnic" id="cashier_cnic" value="{{ old('cashier_cnic', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('installment') ? 'is-invalid' : '' }}" name="installment_id" id="installment_id">
                    @foreach($installments as $id => $entry)
                        <option value="{{ $id }}" {{ old('installment_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
