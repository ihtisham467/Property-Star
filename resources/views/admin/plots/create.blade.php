...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.plot.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.plots.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="plotid" class="required">{{ trans('cruds.plot.fields.plotid') }}</label>
                <input class="form-control {{ $errors->has('plotid') ? 'is-invalid' : '' }}" type="text" name="plotid" id="plotid" value="{{ old('plotid', '') }}" placeholder="A-1" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('plot_type') ? 'is-invalid' : '' }}" name="plot_type" id="plot_type" required>
                    ...
                    @foreach(App\Models\Plot::PLOT_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('plot_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('plot_type_other') ? 'is-invalid' : '' }}" type="text" name="plot_type_other" id="plot_type_other" value="{{ old('plot_type_other', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('boulevard') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="boulevard" id="boulevard" value="1" {{ old('boulevard', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('main_road') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="main_road" id="main_road" value="1" {{ old('main_road', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('facing_park') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="facing_park" id="facing_park" value="1" {{ old('facing_park', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('corner') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="corner" id="corner" value="1" {{ old('corner', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('twoor_more_sides_open') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="twoor_more_sides_open" id="twoor_more_sides_open" value="1" {{ old('twoor_more_sides_open', 0) == 1 ? 'checked' : '' }}>
            ...
            {{-- <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prefred_choice') ? 'is-invalid' : '' }}" type="text" name="prefred_choice" id="prefred_choice" value="{{ old('prefred_choice', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_per_marla') ? 'is-invalid' : '' }}" type="number" name="price_per_marla" id="price_per_marla" value="{{ old('price_per_marla', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('land_charges') ? 'is-invalid' : '' }}" type="number" name="land_charges" id="land_charges" value="{{ old('land_charges', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('development_charges') ? 'is-invalid' : '' }}" type="number" name="development_charges" id="development_charges" value="{{ old('development_charges', '0') }}" step="1">
